...
public class StringUtils {
	 ...
	 * @return String that contains a filename and extension preceded by timestamp with seconds
	 */
	public static String CreateTimestamp(String filename, String extension)
	{
		String timeStr = new java.text.SimpleDateFormat("yyyyMMddHHmmss").format(new java.util.Date());
		return (timeStr + "_" + filename +"." +extension);
	}

	public static String CreateTimestamp(String filename)
	{
		String timeStr = new java.text.SimpleDateFormat("yyyyMMddHHmmss").format(new java.util.Date());
		return (timeStr + "_" + filename);
	}
